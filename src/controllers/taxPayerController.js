...
async function createTaxPayer(req, res) {
  try {
    ...
    await propertyInfoCrud.create({
      ...
      agri_mineral_section: agriMineralSection,
      kind_agri: kindAgri,
      area_agri: areaAgri,
      class_agri: classAgri,
      unit_value: unitValue,
      kind_plant: kindPlant,
      no_area: noArea,
      unit_plant: unitPlant,
      kind_com: kindCom,
      area_com: areaCom,
      unit_com: unitCom,
      adjustment,
...
async function insertInvoice(req, res) {
  try {
    ...
    const parsedAssessmentRate = parseFloat(assessment_rate) || null;
    ...
    await invoiceCrudForTreasurer.create({
      ...
      property_use,
      property_type,
      assessment_rate: parsedAssessmentRate,
